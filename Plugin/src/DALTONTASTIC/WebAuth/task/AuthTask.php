...
namespace DALTONTASTIC\WebAuth\task;

use DALTONTASTIC\WebAuth\WebAuth;
...
class AuthTask extends AsyncTask{
    ...
    public function onCompletion(Server $server){
        $plugin = $server->getPluginManager()->getPlugin("WebAuth");
        if($plugin instanceof WebAuth && $plugin->isEnabled()){
